...
// leggendo il tasks.md del progetto, e ⏎ chiamerà scripts/cockpit-run <task>.
...
function Cockpit() {
  ...
  useInput((input, key) => {
    if (key.upArrow) {
      ...
      // step ③: qui → spawn via scripts/cockpit-run <task>
  ...
  return (
    <Box flexDirection="column" borderStyle="round" borderColor="cyan" paddingX={1}>
      ...
      <Text dimColor>cockpit · ↑↓ naviga · ⏎ spawn · q esci</Text>
